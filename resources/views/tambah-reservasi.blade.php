    ...
    <section class="max-w-screen-xl  mx-auto p-4 my-5">
        <div class="w-full p-6 bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700">
            ...
            <form action="{{ route('store-reservasi') }}" method="POST">
                ...
                <div class="mb-5">
                    <label for="jumlah_orang" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Jumlah
                        Orang</label>
                ...
                <div class="mb-5">
                    <label for="aktivitas_id" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Pilih
                        Kegiatan</label>
