...
@section('content')
    <section class="p-4 bg-white rounded-xl lg:p-5 mb-5 shadow-lg">
        <div class="mb-5 flex justify-between items-center">
            ...
            <a href="{{ route('pegawai.tambah-event') }}"
        ...
        <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
            <div class="pb-4 bg-white">
                <form method="GET" action="{{ route('pegawaiDataEvent') }}">
                        ...
                        <tr
                            ...
                            <td class="px-6 py-3">
                                <div class="inline-flex rounded-md shadow-xs" role="group">
                                    <a href="{{ route('pegawai.edit-event', ['id' => $event->id]) }}"
                                            ...
                                            <div class="relative bg-white rounded-lg shadow">
                                                ...
                                                <div class="p-6 space-y-6">
                                                    ...
                                                    <div class="flex items-center justify-end">
                                                        ...
                                                        <form action="{{ route('pegawai.delete-event', $event->id) }}"
                                                            method="post">
                                                            @csrf
                                                            @method('DELETE')
                                                            <button type="submit"
