    ...
    <section class="p-4 bg-white rounded-xl lg:p-5 mb-5 shadow-lg">
        ...
        <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
            <div class="pb-4 bg-white">
                <form method="GET" action="{{ route('pegawai.data-reservasi') }}">
                            ...
                            <td class="px-6 py-3">
                                <div class="inline-flex rounded-md shadow-xs" role="group">
                                    ...
                                    @if ($checkout->status == 'booking' || $checkout->status == 'pending-paid')
                                        <form action="{{ route('pegawai.paid-reservasi', ['id' => $checkout->id]) }}"
                                            method="POST"
                                        ...
                                        <form action="{{ route('pegawai.paid-manual-reservasi', ['id' => $checkout->id]) }}"
                                            method="POST"
                                            ...
                                            <div class="p-4 md:p-5 space-y-4">
                                                <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                                                    <div>
                                                        ...
                                                        <input disabled type="text" name="pelanggan" id="pelanggan"
                                                    ...
                                                    <div>
                                                        ...
                                                        <input disabled type="text" name="aktivitas" id="aktivitas"
                                                    ...
                                                    <div>
                                                        <label for="waktu_mulai"
                                                            ...
                                                            Kedatangan</label>
                                                        <input disabled type="datetime" name="waktu_mulai" id="waktu_mulai"
                                                            value="{{ $checkout->waktu_kedatangan->translatedFormat('d F Y H:i:s') }} WIB"
                                                            class="mt-1 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"
                                                            readonly>
                                                    </div>
                                                    <div>
                                                        <label for="waktu_selesai"
                                                            class="block text-sm font-medium text-gray-700">Waktu
                                                            Selesai</label>
                                                        <input disabled type="datetime" name="waktu_selesai"
                                                            id="waktu_selesai"
                                                            value="{{ $checkout->waktu_selesai->translatedFormat('d F Y H:i:s') }} WIB"
                                                            class="mt-1 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"
                                                            readonly>
                                                    </div>
                                                    <div>
