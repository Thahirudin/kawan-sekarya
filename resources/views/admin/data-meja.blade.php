    ...
    <section class="p-4 bg-white rounded-xl lg:p-5 mb-5 shadow-lg">
        ...
        <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
            <div class="pb-4 bg-white">
                <form method="GET" action="{{ route('adminDataMeja') }}">
                                                ...
                                                <div class="relative bg-white rounded-lg shadow">
                                                    ...
                                                    <div class="p-6 space-y-6">
                                                        ...
                                                        <div class="flex items-center justify-end">
                                                            ...
                                                            <form action="{{ route('admin.destroy-meja', $meja->id) }}"
                                                                method="post">
                                                                @csrf
                                                                @method('DELETE')
                                                                <button type="submit"
                                        ...
                                        <div id="edit-meja{{ $meja->id }}" aria-hidden="true"
                                            ...
                                            <div class="relative p-4 w-full max-w-2xl max-h-full">
                                                ...
                                                <div class="relative bg-white rounded-lg shadow-sm">
                                                    ...
                                                    <form
                                                        action="{{ route('admin.update-meja', ['id' => $meja->id]) }}"
    ...
    <div id="default-modal" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative p-4 w-full max-w-2xl max-h-full">
            ...
            <div class="relative bg-white rounded-lg shadow-sm">
                ...
                <form action="{{ route('admin.store-meja') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    @method('POST')
                    <!-- Modal body -->
                    <div class="p-4 md:p-5 space-y-4">
