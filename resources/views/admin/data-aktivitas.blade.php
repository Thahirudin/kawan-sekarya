    ...
    <section class="p-4 bg-white rounded-xl lg:p-5 mb-5 shadow-lg">
            ...
            <div id="tambah-aktivitas" aria-hidden="true"
                ...
                <div class="relative p-4 w-full max-w-2xl max-h-full">
                    ...
                    <div class="relative bg-white rounded-lg shadow-sm">
                        ...
                        <form
                            action="{{ route('admin.store-aktivitas') }}"
        ...
        <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
            <div class="pb-4 bg-white">
                <form method="GET" action="{{ route('adminDataAktivitas') }}">
                                                ...
                                                <div class="relative bg-white rounded-lg shadow">
                                                    ...
                                                    <div class="p-6 space-y-6">
                                                        ...
                                                        <div class="flex items-center justify-end">
                                                            ...
                                                            <form
                                                                action="{{ route('admin.delete-aktivitas', $aktivitas->id) }}"
                                                                method="post">
                                                                @csrf
                                                                @method('DELETE')
                                                                <button type="submit"
                                        ...
                                        <div id="edit-aktivitas{{ $aktivitas->id }}" aria-hidden="true"
                                            ...
                                            <div class="relative p-4 w-full max-w-2xl max-h-full">
                                                ...
                                                <div class="relative bg-white rounded-lg shadow-sm">
                                                    ...
                                                    <form
                                                        action="{{ route('admin.update-aktivitas', ['id' => $aktivitas->id]) }}"
                                                        method="post" enctype="multipart/form-data">
                                                        @csrf
                                                        @method('PUT')
                                                        <!-- Modal body -->
