    ...
    <div class="w-full bg-white shadow-lg rounded-md p-6">
        ...
        <div class="flex justify-between items-center gap-10">
            ...
            <div class="mb-4 flex items-center">
                ...
                <div>
                    <p class="font-bold text-black">Invoice</p>
                    <p class="text-[0.6rem] font-bold text-[#83A2FF]">gastr7832930rk</p>
                    <p class="text-[0.8rem] text-black">18/03/2024</p>
                </div>
            </div>

            <!-- Tombol Read More dengan ukuran sesuai -->
            <button class="bg-blue-700 text-white px-6 py-2 rounded-md hover:bg-blue-800 h-fit">
                read more
            </button>
        </div>
